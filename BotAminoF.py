...
with suppress(Exception):
    for i in (path_utilities, path_amino, path_picture, path_sound, path_download):
...
class Parameters:
    __slots__ = ("subClient", "chatId", "authorId", "author", "message", "messageId", "authorIcon", "comId", "reply", "replySrc", "info")
